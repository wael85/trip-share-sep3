...
public final class UserGrpc {
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType = via.sep3.grpcserver.protobuf.user.RequestUserInfo.class,
      responseType = via.sep3.grpcserver.protobuf.user.ResponseUserInfo.class,
  ...
  public static abstract class UserImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void createUser(via.sep3.grpcserver.protobuf.user.RequestUserInfo request,
        io.grpc.stub.StreamObserver<via.sep3.grpcserver.protobuf.user.ResponseUserInfo> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                via.sep3.grpcserver.protobuf.user.RequestUserInfo,
                via.sep3.grpcserver.protobuf.user.ResponseUserInfo>(
  ...
  public static final class UserBlockingStub extends io.grpc.stub.AbstractBlockingStub<UserBlockingStub> {
    ...
    /**
     */
    public via.sep3.grpcserver.protobuf.user.ResponseUserInfo createUser(via.sep3.grpcserver.protobuf.user.RequestUserInfo request) {
  ...
  public static final class UserFutureStub extends io.grpc.stub.AbstractFutureStub<UserFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<via.sep3.grpcserver.protobuf.user.ResponseUserInfo> createUser(
        via.sep3.grpcserver.protobuf.user.RequestUserInfo request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_USER:
          serviceImpl.createUser((via.sep3.grpcserver.protobuf.user.RequestUserInfo) request,
              (io.grpc.stub.StreamObserver<via.sep3.grpcserver.protobuf.user.ResponseUserInfo>) responseObserver);
          break;
        default:
